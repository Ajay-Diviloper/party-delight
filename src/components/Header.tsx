...
export default function Header() {
  ...
  return (
    <>
      ...
      <div className="w-full bg-[#ff3131] text-white text-base hidden lg:block font-montaga">
  ...
  >
      ...
      <header className="w-full bg-white/70 backdrop-blur-md shadow-md sticky top-0 z-50">
        ...
        <div className="container mx-auto px-4 py-1 flex items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            >
              <Search className="w-5 h-5 hover:text-gray-700 text-[#ff3131]" />
            </button>
          </div>
        </div>
    ...
    {/* Search Popup */}
{isSearchOpen && (
  <div className="fixed inset-0 z-[99999] flex items-center justify-center bg-black/70 bg-opacity-70 min-h-screen">
    <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md mx-4 relative flex flex-col justify-center items-center">
      {/* Close Button */}
      <button
      ...
      {/* Heading */}
      <h2 className="text-lg font-semibold mb-4 text-center font-montaga">
      ...
      <ul className="max-h-60 overflow-y-auto w-full">
        ...
        {/* Mobile Menu Sidebar */}
        <div
          className={`lg:hidden fixed top-0 left-0 h-screen w-full max-w-[100vw] bg-white z-[9999] transform transition-transform duration-300 ease-in-out ${
        ...
        >
          ...
          <div className="border-t border-gray-200 bg-white px-6 py-5">
            <h3 className="font-heading text-[20px] sm:text-lg text-[#ff3131] font-normal mb-3">Get in touch with us</h3>
            <div className="space-y-3 text-[15px] text-gray-700">
              <div className="flex items-center gap-2">
                <MapPin className="w-5 h-5 text-[#ff3131] flex-shrink-0" />
              ...
              <a href="mailto:partydelightsca@outlook.com" className="flex items-center gap-2 hover:underline">
                <Mail className="w-5 h-5 text-[#ff3131] flex-shrink-0" />
                <span>partydelightsca@outlook.com</span>
              </a>
              <a href="tel:6045930080" className="flex items-center gap-2 hover:underline">
                <Phone className="w-5 h-5 text-[#ff3131] flex-shrink-0" />
                <span>(604) 593-0080</span>
              </a>
            </div>
            <div className="flex gap-3 pt-4 w-full justify-baseline items-center flex-wrap">
              <a
                href="https://www.facebook.com/partydelightsca/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-2 rounded-full bg-gray-100 hover:bg-[#ff3131] transition-colors flex items-center justify-center"
                style={{ minWidth: 0 }}
              >
                <Facebook className="w-6 h-6 text-[#ff3131] hover:text-white" />
              </a>
              <a
                href="https://www.instagram.com/partydelightsca/?hl=en"
                target="_blank"
                ...
                style={{ minWidth: 0 }}
              >
                <Instagram className="w-6 h-6 text-[#ff3131] hover:text-white" />
              </a>
            </div>
          </div>
          </div>
