...
const info = [
  { 
    icon: FiMapPin, 
    lines: ['6638 152A St #115, Surrey, BC V3S 5X5'], 
    href: "https://maps.app.goo.gl/Vxs2SKxLEQh2Bjp3A" 
  },
  { 
    icon: FiPhone,  
    lines: ['+1 (604) 593-0080'], 
    href: "tel:+16045930080" 
  },
  { 
    icon: FiMail,   
    lines: ['partydelightsca@outlook.com'], 
    href: "mailto:partydelightsca@outlook.com" 
  },
];
