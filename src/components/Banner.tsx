...
const Banner: React.FC<BannerProps> = ({ title, subtitle }) => (
  <section className="relative w-full h-[50vh] md:h-[70vh] flex items-center justify-center overflow-hidden">
    ...
    <div className="relative z-[2] flex flex-col items-center justify-center w-full h-screen text-center px-4">
      <h1 className="text-white font-heading text-3xl sm:text-5xl md:text-6xl mb-4 capitalize">
        {title}
      </h1>
      <span className="text-white text-base md:text-lg max-w-xl mt-3 mb-8 font-sans capitalize">
        {subtitle}
      </span>
    </div>
  </section>
