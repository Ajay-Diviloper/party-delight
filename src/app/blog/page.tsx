    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#ff3131] mx-auto mb-4"></div>
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-16 max-w-9xl flex flex-col md:flex-row gap-8 relative">
        ...
        <button
          className="md:hidden mb-4 px-4 py-2 border border-[#ff3131] text-[#ff3131] rounded font-heading text-lg w-max"
        ...
        {sidebarOpen && (
          <Fragment>
            ...
            >
              <button
                className="self-end mb-4 text-2xl font-bold text-[#ff3131]"
                onClick={() => setSidebarOpen(false)}
                  ...
                  {categories.map((cat) => (
                    <li key={cat}>
                      <button
                        ...
                        className={`w-full text-left px-3 py-2 rounded font-heading text-lg transition-colors duration-200 ${selectedCategory === cat ? 'bg-[#ff3131] text-white' : 'bg-gray-100 text-[#ff3131] hover:bg-[#ff3131] hover:text-white'}`}
                      >
                        {cat}
                      </button>
                    </li>
                  ...
                  {tags.map((tag) => (
                    <li key={tag}>
                      <button
                        ...
                        className={`w-full text-left px-3 py-2 rounded font-heading text-lg transition-colors duration-200 ${selectedTag === tag ? 'bg-[#ff3131] text-white' : 'bg-gray-100 text-[#ff3131] hover:bg-[#ff3131] hover:text-white'}`}
                      >
                        {tag}
                      </button>
                    </li>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            ...
            <div className="flex items-center gap-4">
              <select
                ...
                className="border border-gray-300 rounded px-3 py-2 font-sans text-sm focus:outline-none focus:border-[#ff3131]"
              >
          ...
          {totalPages > 1 && (
            <div className="flex justify-center items-center gap-2 mt-12">
              <button
                ...
                className="px-4 py-2 border border-gray-300 rounded font-heading text-sm disabled:opacity-50 disabled:cursor-not-allowed hover:bg-[#ff3131] hover:text-white transition-colors"
              >
                Previous
              </button>
                ...
                <button
                  ...
                  className={`px-4 py-2 border rounded font-heading text-sm transition-colors ${
                    currentPage === page
                      ...
                      : 'border-gray-300 hover:bg-[#ff3131] hover:text-white'
                  }`}
                >
                  {page}
                </button>
