      ...
      <div className="max-w-5xl mx-auto px-6 pb-16">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 text-sm text-gray-600 mb-4">
            <span className="inline-block bg-gray-100 text-[#ff3131] px-3 py-1 rounded-full text-xs font-semibold">
              {blog.category}
            </span>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            ...
            <div className="flex flex-wrap gap-2">
              {blog.tags.map((tag, index) => (
                <span 
                  key={index}
                  className="bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm hover:bg-[#ff3131] hover:text-white transition-colors duration-200 cursor-pointer"
                >
                  #{tag}
                </span>
              ))}
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex items-start gap-4">
            <div className="w-16 h-16 bg-[#ff3131] rounded-full flex items-center justify-center text-white font-heading font-bold text-xl">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <Link 
            href="/blog"
            className="inline-flex items-center gap-2 text-[#ff3131] font-semibold hover:text-dark-brown transition-colors duration-200"
          >
